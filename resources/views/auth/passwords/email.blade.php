            ...
            <div class="relative overflow-hidden p-8 text-white text-center">
                ...
                <div class="relative">
                    <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-4 shadow-md">
                        <i class="fas fa-key text-4xl text-teal-600"></i>
                    </div>
                    <h1 class="text-3xl font-bold mb-2 drop-shadow-lg">Reset Password</h1>
                    <p class="text-white text-opacity-80">Recover your account</p>
                </div>
            </div>
            ...
            <div class="p-8">
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <button type="submit" 
                        ...
                        <span class="relative"><i class="fas fa-paper-plane mr-2"></i>Send Reset Link</span>
                    </button>
                </form>
