        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-slate-200">
            ...
            <div class="relative overflow-hidden p-8 text-white text-center">
                ...
                <div class="relative">
                    ...
                    <h1 class="text-3xl font-bold mb-2 drop-shadow-lg">Create Account</h1>
                    <p class="text-white text-opacity-80">Join Job Order System</p>
                </div>
            </div>
            ...
            <div class="p-8">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <button type="submit" 
                        ...
                        <span class="relative"><i class="fas fa-user-plus mr-2"></i>Create Account</span>
                    </button>
                </form>
                ...
                <div class="mt-6 text-center">
                    <p class="text-slate-600 text-sm">
                        ...
                        <a href="{{ route('login') }}" class="text-teal-600 hover:text-teal-800 font-semibold transition">
                            Sign in here
                        </a>
                    </p>
                </div>
